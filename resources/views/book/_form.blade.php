        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg order-1 order-lg-0">
                    <div class="card mb-5">
                        <form action="{{ route('book.update', encrypt($book->id)) }}" method="POST"
                                ...
                                <div class="row g-3">
                                        ...
                                        <select class="select2 select2bs4 form-control" id="medium" name="medium[]"
                                            ...
                                            @foreach ($mediums as $medium)
                                                <option value="{{ $medium->id }}"
                                                    {{ in_array($medium->id, $medium_id) ? 'selected' : '' }}>
                                                    {{ $medium->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('medium')
                                    ...
                                    <div class="col-md-6 mb-3 col-sm-12">
                                        ...
                                        <input type="number" class="form-control" name="price" id="price"
                                            placeholder="Book Price" value="{{ old('price', $book->price) }}" />
                                        @error('price')
                                            <span class="error">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6 mb-3 col-sm-12">
                                        ...
                                        <input type="number" class="form-control" name="qty" id="qty"
                                            placeholder="Book Quantity" value="{{ old('qty', $book->qty) }}" />
                                        @error('qty')
                                            <span class="error">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 mb-3 col-sm-12">
                                        ...
                                        <input type="number" class="form-control" name="discount" id="discount"
                                            placeholder="Book Discount" value="{{ old('discount', $book->discount) }}" />
                                        @error('discount')
                                            <span class="error">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 mb-3 col-sm-12">
                                        ...
                                        <div class="radio">
                                            <label for="amount"><input type="radio" name="discount_type" id="amount"
                                                    value="0"
                                                    {{ $book->discount_type == 0 ? 'checked' : '' }}>Amount</label>
                                            <label for="percentage"><input type="radio" name="discount_type" id="percentage"
                                                    value="1"
                                                    {{ $book->discount_type == 1 ? 'checked' : '' }}>Percentage</label>
                                        </div>
